...
class ServerTest {
    ...
    void appendEntriesTest() {
        ...
        ent.put(0, new LogEntry(0, "x", 1, 0, 0));
        ent.put(1, new LogEntry(0, "x", 2, 0, 1));
        ent.put(2, new LogEntry(0, "x", 3, 0, 2));
        ent.put(3, new LogEntry(0, "x", 4, 0, 3));
        ...
        ent2.put(2, new LogEntry(1, "x", 4, 0, 2));
